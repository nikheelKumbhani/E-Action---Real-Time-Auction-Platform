...
export const Header = () => {
  ...
  return (
    <>
      <header className={isHomePage ? `header py-1  ${isScrolled ? "scrolled" : ""}` : `header bg-white shadow-s1 ${isScrolled ? "scrolled" : ""}`}>
        <Container>
            ...
            <div className="flex items-center gap-14">
              <div>
                {isHomePage && !isScrolled ? (
                  // <img
                  //   src="../images/common/auction-hub-logo.jpg"
                  //   alt="LogoImg"
                  //   style={{
                  //     height: '44px',
                  //     float: 'left',
                  ...
                  <img
                    src="../images/common/auction-hub-logo2.jpg"
                    alt="LogoImg"
                    style={{
                      height: '50px',
                      float: 'left',
